...
public class Add extends AppCompatActivity {
    ...
    EditText edit_memo_title;
    EditText edit_memo_content;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_memo_title = (EditText)findViewById(R.id.edit_memo_title);
        ...
        btn_check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String edit_title = edit_memo_title.getText().toString();
                String edit_content = edit_memo_content.getText().toString();
